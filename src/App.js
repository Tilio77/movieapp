...
function App() {
  ...
  const API_KEY = '7db2f1645557c2b857315ecdf4dc1947'
  ...
  // Función para la petición de un solo objeto y mostrar el reproductor de vídeo.
  ...
  return (
    <div>
      ...
      {/* Aquí va todo el contenedor del banner y del reproductor de vídeo */}
      <div>
        <main>
          {movie ? (
            <div
